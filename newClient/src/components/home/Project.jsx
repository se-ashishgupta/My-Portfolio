    ...
    <div className="mb-[2.5rem] m-[10px] xl:m-[15px]  border-2 border-primary_color rounded-sm shadow-lg shadow-primary_color ">
      ...
      <div className=" relative pt-[1rem] pb-[1rem] px-[1rem] ">
        ...
        <a
          href={item.live_link}
          target="blank"
          className="w-min text-lg flex items-center gap-2 text-white font-medium border-2 p-1 rounded-lg border-primary_color hover:text-primary_color hover:border-white transition-all duration-300"
        >
